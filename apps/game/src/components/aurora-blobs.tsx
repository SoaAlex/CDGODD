...
const BLOBS: BlobConfig[] = [
  { color: '#7dd3fc', size: 0.9,  x0: -0.3,  y0: -0.2,  dx: 0.45,  dy: 0.3,   durX: 12000, durY: 9000,  durScale: 10000, scaleMin: 0.85, scaleMax: 1.2,  opacity: 0.7,  phase: 0 },
  { color: '#c084fc', size: 1.1,  x0: 0.6,   y0: -0.05, dx: -0.4,  dy: 0.35,  durX: 13000, durY: 10000, durScale: 8000,  scaleMin: 0.8,  scaleMax: 1.15, opacity: 0.75, phase: 0.35 },
  { color: '#f0abfc', size: 0.75, x0: 0.05,  y0: 0.5,   dx: 0.5,   dy: -0.3,  durX: 10000, durY: 13000, durScale: 11000, scaleMin: 0.85, scaleMax: 1.25, opacity: 0.65, phase: 0.65 },
  { color: '#818cf8', size: 1.0,  x0: -0.15, y0: 0.75,  dx: 0.4,   dy: -0.35, durX: 14000, durY: 9000,  durScale: 10000, scaleMin: 0.85, scaleMax: 1.15, opacity: 0.75, phase: 0.9 },
];
